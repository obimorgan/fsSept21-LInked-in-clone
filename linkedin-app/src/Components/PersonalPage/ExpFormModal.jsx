...
const ExpFormModal = ({ lgShow, id, setLgShow }) => {
    ...
    <>
      <Form>
        <Modal
          size="lg"
          show={lgShow}
          onHide={handleClose} ///// need to fix this!! this allows for the for to close
        ...
        >
          ...
          <Modal.Body>
            ...
            <Button
              variant=""
              className="rounded-pill add-media text-primary border-primary"
            >
              <IoMdAdd />
              Add media
            </Button>
